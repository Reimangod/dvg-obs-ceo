"""Fresh sequential integration of calibrated conditional polishing on LiH."""
...
OUTPUT = ROOT / "artifacts/v5/s8/lih-cp-integration-v1"
RUNNER_VERSION = "v5-s8-lih-cp-integration-v1"
